...
- *(flake)* add sidequest control plane to the dev shell; fix runner Nix builds (#299)
...
- *(config)* add fine-grained PR metadata controls (#281)

### Fixed

- *(opencode)* require delegated RGR RED approval (#283)
...
- *(nixos)* harden gateway module for production (#271)
