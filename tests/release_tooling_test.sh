...
PY
  ...
  assert_file_contains "$prepare_workflow" 'GIT_AUTHOR_NAME: Auto Review Bot' "release PR preparation workflow gives release-plz a git author name"
  assert_file_contains "$prepare_workflow" 'GIT_AUTHOR_EMAIL: auto-review@noreply.git.johnwilger.com' "release PR preparation workflow gives release-plz a git author email"
  assert_file_contains "$prepare_workflow" 'GIT_COMMITTER_NAME: Auto Review Bot' "release PR preparation workflow gives release-plz a git committer name"
  assert_file_contains "$prepare_workflow" 'GIT_COMMITTER_EMAIL: auto-review@noreply.git.johnwilger.com' "release PR preparation workflow gives release-plz a git committer email"
