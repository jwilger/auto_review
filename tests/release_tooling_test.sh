...
scripts=(
  ...
  "$TEST_DIR/opencode_adr_guard_test.sh"
  "$TEST_DIR/opencode_adr_create_test.sh"
  "$TEST_DIR/opencode_adr_update_test.sh"
  "$TEST_DIR/opencode_adr_supersession_test.sh"
  "$TEST_DIR/opencode_adr_delete_unmerged_test.sh"
  "$TEST_DIR/opencode_adr_transition_test.sh"
