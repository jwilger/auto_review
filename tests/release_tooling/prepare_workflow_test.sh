...
PY
  ...
  assert_file_not_contains "$publish_workflow" 'docker://git.johnwilger.com/jwilger/auto_review/ar-gateway-pr:release-v$RELEASE_VERSION"' "publish workflow does not promote the mutable version-only release PR Docker image after the release PR merges to main"
