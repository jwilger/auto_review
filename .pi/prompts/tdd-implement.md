...
This command is a compatibility entry point for the specialist-agent RGR workflow. Do not perform code-writing steps directly when the RED/GREEN/review agents can own the step via the Pi subagents `Agent` tool.
