...
| `dispatcher::run_review_job` | The end-to-end review pipeline activity: clone, lint, RAG-context, review, verify, post. Used by both the dispatcher and the `auto_review review-once` CLI command. |
